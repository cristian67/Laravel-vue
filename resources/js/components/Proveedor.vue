                     ...
                     <div class="form-group row">
                         <div class="col-md-6">
                             <div class="input-group">
                                 ...
                                 <input type="text" v-model="buscar" @keyup.enter="listPersona(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
                                 <button type="submit" @click="listPersona(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                             </div>
                         </div>
                     </div>
                     ...
                     <div class="modal-body">
                         <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                 ...
                                 <div class="col-md-9">
                                     <input type="tect" v-model="contacto" class="form-control" placeholder="Nombre del contacto">
                                 </div>
                            </div>                               
                            ...
                            <div class="form-group row">
                                 ...
                                 <div class="col-md-9">
                                     <input type="tect" v-model="telefono_contacto" class="form-control" placeholder="Teléfono del contacto">
                                 </div>
                            </div>                   
...
export default {
    ...
    //Funciones    
    methods: {
        listPersona(page, buscar, criterio){
            let me  = this;
            var url = '/proveedor?page='+page+'&buscar='+buscar+'&criterio='+criterio; 
                axios.get(url)   
                            .then(function (response) {
                                var resp = response.data; 
                                me.arrayPersona = resp.proveedores.data;
        ...
        cambiarPagina(page, buscar, criterio){
            ...
            me.listPersona(page, buscar, criterio);
        },
            ...
            axios.post('/proveedor/registrar', 
                       {
                           ...
                           //Si todo sale bien se ejecuta cerrar y listar   
                           me.cerrarModal();
                           me.listPersona(1,'','nombre');
                       }).catch(function (error) {
                                    console.log(error);
            });
        },
        ...
        validarPersona(){
            ...
            if (!this.nombre) 
            {
                this.errorMostrarMsjPersona.push("El nombre no puede estar vacío!. ");    
            }
    ...
    mounted() {
           this.listPersona(1,this.buscar,this.criterio);
    }
